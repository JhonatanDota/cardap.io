...
export default function AdminMenuItem(props: AdminMenuItemProps) {
  ...
  return (
    <div className="flex items-center gap-1.5 md:gap-2 w-full h-14 md:h-20 px-5 md:px-8 rounded hover:bg-gray-700 hover:text-gray-300 transition-colors overflow-hidden">
