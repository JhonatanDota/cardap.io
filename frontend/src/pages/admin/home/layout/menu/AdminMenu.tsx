...
export default function AdminMenu() {
  return (
    <div>
      ...
      <div className="flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-900 rounded-r-lg">
        <a className="flex flex-col items-center w-full mt-1" href="#">
          ...
          <span className="text-sm font-bold">Cardap.io</span>
        </a>

        <div className="flex flex-col w-full p-2 mt-3 border-t border-gray-700">
          <Link to={"/"}>
            <AdminMenuItem name="Dashboard" icon={<HomeIcon />} />
          </Link>

          <Link to={"/"}>
            <AdminMenuItem name="Métricas" icon={<MetricsIcon />} />
          </Link>

          <Link to={"/"}>
            <AdminMenuItem name="Cardap.io" icon={<CardapioIcon />} />
          </Link>
        </div>
      </div>
    </div>
